...
public class ViewProfileServlet extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<head>\r\n"
				...
				+ "        <style>\r\n"
				+ "body {\r\n"
				+ "  background-image: url('https://image.shutterstock.com/z/stock-vector-info-icon-symbol-premium-quality-isolated-personal-data-info-icon-element-with-also-person-contact-670045903.jpg');\r\n"
				+ "}\r\n"
				+ "</style>\r\n"
				+ "        \r\n"
				+ "    </head>");
